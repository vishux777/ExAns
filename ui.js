  ...
  try {
    ...
    switch (method) {
      ...
      case 'console':
        ...
        break;
      case 'notification':
        window.showNotification(answer);
        break;
      case 'canvas':
...
function showConsole(answer) {
  try {
    ...
    window.showNotification("Answer available in browser console (F12)");
  } catch (error) {
